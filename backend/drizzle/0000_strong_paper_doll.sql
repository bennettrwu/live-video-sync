...
CREATE TABLE IF NOT EXISTS "roomUsers" (
	...
	CONSTRAINT "test" PRIMARY KEY("roomId","userId")
);
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "roomsUsersRoomIdIndex" ON "roomUsers" USING btree ("roomId");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "roomsUsersUserIdIndex" ON "roomUsers" USING btree ("userId");--> statement-breakpoint
